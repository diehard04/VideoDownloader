package com.diehard04.videodownloader.Models;
...
import com.diehard04.videodownloader.Interfaces.VideoDownloader;
...
public class InstagramVideoDownloader implements VideoDownloader {
    ...
    public String createDirectory() {
        File folder = new File(Environment.getExternalStorageDirectory() + File.separator + "My Video Downloader");
